...
<div className='flex flex-col gap-4'>
  ...
  ![Diretório eventos](./assets/dir-events.png)\
  A pasta `events/` irá armazenar eventos do discord.py, por exemplo, quando uma mensagem é recebida ou quando um membro se junta a um servidor.
